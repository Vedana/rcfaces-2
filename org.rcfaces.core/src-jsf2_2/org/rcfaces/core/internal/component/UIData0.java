...
import javax.faces.component.TransientStateHolder;
...
public class UIData0 extends UIComponentBase
    ...
    protected Map<String, Object> _rowDeltaStates = new HashMap<String, Object>();
    protected Map<String, Object> _rowTransientStates = new HashMap<String, Object>();
    ...
    public boolean invokeOnComponent(FacesContext context, String clientId,
        ...
        if (clientId.equals(myId)) {
            try {
                this.pushComponentToEL(context, getCompositeComponentParent(this));//compositeParent
    ...
    public void processDecodes(FacesContext context) {
        ...
        preDecode(context);
        decode(context); //permet d'avoir la map index reel apres filtre et tri avant de decode les enfants 
        iterate(context, PhaseId.APPLY_REQUEST_VALUES);//inverse avec decode en 1.2
...
//    }
    ...
    private boolean keepSaved(FacesContext context) {
        ...
        return true; // OO force la sauvegarde !(contextHasErrorMessages(context) || isNestedWithinIterator());
