...
public class ComponentStateHelper0 implements StateHelper , TransientStateHelper {

    protected UIComponent component;
    private boolean isTransient;
    protected Map<Serializable, Object> deltaMap;
    protected Map<Serializable, Object> defaultMap;
    protected Map<Object, Object> transientState;
    ...
    public Object eval(Serializable key, Object defaultValue) {
    	...
    	if(defaultValue instanceof FacesContext) {
    		defaultValue = null; // eval généré
    	}
