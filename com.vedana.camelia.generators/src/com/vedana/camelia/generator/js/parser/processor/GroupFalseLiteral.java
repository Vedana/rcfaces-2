/*
 * $Id: GroupFalseLiteral.java,v 1.1 2009/01/15 15:16:52 oeuillot Exp $
 */
...
public class GroupFalseLiteral extends AbstractGroupLiterals {
    ...
    public boolean process(JsStats stats, IJsFile jsFile) {
        return process(stats, jsFile, new ISetLiteralCondition() {
            ...
            public boolean testLiteral(Assignment assignment,
                    Assignment original) {
                return FalseLiteral.class.isInstance(assignment.getRight());
            }
